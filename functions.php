...
{
    register_taxonomy_for_object_type('category', 'why'); // Register Taxonomies for Category
    register_taxonomy_for_object_type('post_tag', 'why');
    register_post_type('why', // Register Custom Post Type
        array(
        'labels' => array(
            'name' => __('Why Universal', 'why'), // Rename these to suit
            'singular_name' => __('Why Universal', 'why'),
            'add_new' => __('Add New', 'why'),
            'add_new_item' => __('Add New Why Universal', 'why'),
            'edit' => __('Edit', 'why'),
            'edit_item' => __('Edit Why Universal', 'why'),
            'new_item' => __('New Why Universal', 'why'),
            'view' => __('View Why Universal', 'why'),
            'view_item' => __('View Why Universal', 'why'),
            'search_items' => __('Search Why Universal', 'why'),
            'not_found' => __('No Why Universals found', 'why'),
            'not_found_in_trash' => __('No Why Universals found in Trash', 'why')
        ),
    ...
    register_taxonomy_for_object_type('category', 'diamonds'); // Register Taxonomies for Category
    register_taxonomy_for_object_type('post_tag', 'diamonds');
    register_post_type('diamonds', // Register Custom Post Type
        array(
        'labels' => array(
            'name' => __('Diamonds 101', 'diamonds'), // Rename these to suit
            'singular_name' => __('Diamonds 101', 'diamonds'),
            'add_new' => __('Add New', 'diamonds'),
            'add_new_item' => __('Add New Diamonds 101', 'diamonds'),
            'edit' => __('Edit', 'diamonds'),
            'edit_item' => __('Edit Diamonds 101', 'diamonds'),
            'new_item' => __('New Diamonds 101', 'diamonds'),
            'view' => __('View Diamonds 101', 'diamonds'),
            'view_item' => __('View Diamonds 101', 'diamonds'),
            'search_items' => __('Search Diamonds 101', 'diamonds'),
            'not_found' => __('No Diamonds 101s found', 'diamonds'),
            'not_found_in_trash' => __('No Diamonds 101s found in Trash', 'diamonds')
        ),
